# :dollar: UWaterloo Bursary Application
...
**Technologies Used:**
- Back-end: Python, Flask, psycopg2, APScheduler
- Front-end: React, Tailwind CSS
- Deployment: Gunicorn, Nginx, Docker, Let's Encrypt (SSL)
- Cloud: AWS VPC, AWS EC2, AWS RDS (PostgreSQL)
